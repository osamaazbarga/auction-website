    ...
    return (
      ...
      >
          {({ errors, touched, setFieldValue }) => (
              ...
              <Field className="input drop" name="condition" as="select">
             ...
             <div className="row">
               <div className="col-4">
                 <from action="/products/addproduct" enctype="multipart/from-data" method="POST">
                   <div className="row">
                     <div className="col-8">
                       <input type="file" className="from-control" name="images" id="fromFile" multiple onChange={(event) => {setFieldValue("file", event.currentTarget.files)}}/>
                     </div>
             ...
             {/* <div className="row mt-3">
              ...
              <div className="row">
                <div className="col-6">
                    ...
                    <Field className="input" name="shippingprice" type="number"/>
                  </div>
                  <div className="col-6">
